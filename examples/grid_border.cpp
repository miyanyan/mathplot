...
int main()
{
    ...
    gv->addLabel ("1) Base GridVisMode::RectInterp", sm::vec<float>({0,-0.2,0}), morph::TextFeatures(0.05f));
    gv->finalize();
    v.addVisualModel (gv);
    ...
    gv->addLabel ("2) 1 + no zScale", sm::vec<float>({0,-0.2,0}), morph::TextFeatures(0.05f));
    gv->finalize();
    v.addVisualModel (gv);
    ...
    gv->addLabel ("3) 2 + flat border", sm::vec<float>({0,-0.2,0}), morph::TextFeatures(0.05f));
    gv->finalize();
    v.addVisualModel (gv);
    ...
    gv->border_colour = morph::colour::cyan;
    gv->border_tubular (false);
    gv->addLabel ("4) 1 + flat border", sm::vec<float>({0,-0.2,0}), morph::TextFeatures(0.05f));
    gv->finalize();
    v.addVisualModel (gv);
    ...
    gv->addLabel ("5) 2 + grid ", sm::vec<float>({0,-0.2,0}), morph::TextFeatures(0.05f));
    gv->finalize();
    v.addVisualModel (gv);
    ...
    gv->addLabel ("6) 5 + tubular border ", sm::vec<float>({0,-0.2,0}), morph::TextFeatures(0.05f));
    gv->finalize();
    v.addVisualModel (gv);
    ...
    gv->addLabel ("7) 2 + selected pixel borders", sm::vec<float>({0,-0.2,0}), morph::TextFeatures(0.05f));
    gv->finalize();
    v.addVisualModel (gv);
    ...
    gv->addLabel ("8) 7 + grid", sm::vec<float>({0,-0.2,0}), morph::TextFeatures(0.05f));
    gv->finalize();
    v.addVisualModel (gv);
